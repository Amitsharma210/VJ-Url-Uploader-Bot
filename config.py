...
class Config(object):
    ...
    TECH_VJ_DATABASE_URL = os.environ.get("TECH_VJ_DATABASE_URL", "mongodb+srv://eyemaycup:Mnisb8Evl7MLDQA9@cluster0.k1kwriu.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
