...
class Config(object):
    # Bot Information 
    TECH_VJ_BOT_TOKEN = os.environ.get("TECH_VJ_BOT_TOKEN", "7054282162:AAFzuU_0Gj96Uy7lNGphzDn3MEwQ3bBp3Qo")
    TECH_VJ_BOT_USERNAME = os.environ.get("TECH_VJ_BOT_USERNAME", "url2uploaderbot") # Bot username without @.
    
    # The Telegram API things
    TECH_VJ_API_ID = int(os.environ.get("TECH_VJ_API_ID", "22164996"))
    TECH_VJ_API_HASH = os.environ.get("TECH_VJ_API_HASH", "035f2448fefaf28659b05af05142b45b")
    ...
    TECH_VJ_OWNER_ID = int(os.environ.get("TECH_VJ_OWNER_ID", "5587203970")) 
    TECH_VJ_SESSION_NAME = "VJ-URL-UPLOADER-BOT"
    
    # database uri (mongodb)
    TECH_VJ_DATABASE_URL = os.environ.get("TECH_VJ_DATABASE_URL", "mongodb+srv://ronnypvt:Ronny@123@atlascluster.pmad8qm.mongodb.net/?retryWrites=true&w=majority&appName=AtlasCluster")
    TECH_VJ_MAX_RESULTS = "50"

    # channel information
    TECH_VJ_LOG_CHANNEL = int(os.environ.get("TECH_VJ_LOG_CHANNEL", "-1002006067617")) # your log channel id and make bot admin in log channel with full right 
